!function () {
    ...
    y.version = "2.0.4";
    var w, b;
    const bodyW = document.querySelectorAll('body')[0].clientWidth; // 获取宽度计算 count点
    new y(document.querySelectorAll('.blog-container')[0], (w = document.getElementsByTagName("script"), {

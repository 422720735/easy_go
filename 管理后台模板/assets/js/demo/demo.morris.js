...
$(document).ready(function() {
    setTimeout(function() {
        ...
        Morris.Bar({
            ...
            barColors: ["#5d78ff", "#0abb87", "#fd397a"]
        });
        ...
        Morris.Bar({
            ...
            ykeys: ['a', 'b', 'c'],
            labels: ['Bar 1', 'Bar 2', 'Bar 3'],
            barColors: ["#ffb822", "#fd397a", "#5d78ff"]
        });
        ...
        Morris.Area({
            ...
            lineColors: ['#0abb87', '#ffb822', '#5d78ff'],
            xkey: 'period',
        ...
        var graph_real = Morris.Line({
            ...
            ymin: -1.0,
            ymax: 1.0,
            lineColors: ['#ffb822', '#fd397a', '#5d78ff'],
            pointSize: 4,
            responsive: true,
            pointFillColors: ['#fff', '#fff', '#fff'],
            pointStrokeColors: ['#ffb822', '#fd397a', '#5d78ff'],
            lineWidth: 2,
            hideHover: true
        });
